...
module S04_DataKinds.DataKinds where

{- Today's will focus on one of my favourite GHC magic tricks: the
DataKinds extension. We'll see how and to use it to enhance
