...
module S03_KindSignatures.KindSignatures where

{- 3, KindSignatures and the ways in which they can help us. 
  We'll see where we need them, and where they're just good documentation.. 
