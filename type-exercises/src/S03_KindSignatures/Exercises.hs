...
module S03_KindSignatures.Exercises where
...
instance Question10 (Monad Maybe, Eq a, Show a)
instance Question10 (Eq a, Show a)

--

class Oh (a :: Type -> Constraint) 
instance Oh Eq 

class Hm (a :: Constraint) 
instance Hm (Eq a, Show a)
